...
PlotMuAndSigmaFromFiles(fileNames_pB[0], fileNames_eB[0], pT_bins, 0,"Both_varied (EB)", "pT", 0.99, 1.015, 0.985, 1.004, 0.0, 0.02, 0.8, 1.2, "pT[GeV/c]", "Barrel");
...
PlotMuAndSigmaFromFiles(fileNames_pE[0], fileNames_eE[0], pT_bins, 0,"Both_varied (EE)", "pT", 0.97, 1.02, 0.96, 1.015, 0.01, 0.04, 0.8, 1.25, "pT[GeV/c]", "Endcap");
