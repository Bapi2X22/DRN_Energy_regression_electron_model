...
void plotSigmaOverMuMulti() {
    std::vector<std::string> fileNames = {
        "Plot_ele_model_endcap_1.root",
        "Plot_ele_model_endcap_2.root",
        "Plot_ele_model_endcap_3.root",
        "Plot_ele_model_endcap_4.root"
    };
...
{2.0, 2.1}, {2.1, 2.2}, {2.2, 2.3}, {2.3, 2.4},
    ...
    if (isMu) {
        ...
        TH1F *frame = pad2->DrawFrame(xmin, 0.85, xmax, 1.15);
    }
...
plotGraphs(graphs_sigma_BDT, "#sigma/#mu vs |#eta|_endcap (BDT)", "#sigma/#mu", "sigma_over_mu_vs_eta_BDT_endcap_ele_M", false);
plotGraphs(graphs_sigma_DRN, "#sigma/#mu vs |#eta|_endcap (DRN)", "#sigma/#mu", "sigma_over_mu_vs_eta_DRN_endcap_ele_M", false);
plotGraphs(graphs_mu_BDT, "#mu vs |#eta| (BDT)_endcap", "Response", "mu_vs_eta_BDT_endcap_ele_M", true);
plotGraphs(graphs_mu_DRN, "#mu vs |#eta| (DRN)_endcap", "Response", "mu_vs_eta_DRN_endcap_ele_M", true);
