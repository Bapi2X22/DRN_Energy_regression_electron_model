...
void plotSigmaOverMuMulti() {
    ...
    frame->GetXaxis()->SetTitle("pT [GeV/c]");
...
plotGraphs(graphs_sigma_BDT, "#sigma/#mu vs pT_barrel (BDT)", "#sigma/#mu", "sigma_over_mu_vs_pT_BDT_barrel_ele_M", false);
plotGraphs(graphs_sigma_DRN, "#sigma/#mu vs pT_barrel (DRN)", "#sigma/#mu", "sigma_over_mu_vs_pT_DRN_barrel_ele_M", false);
plotGraphs(graphs_mu_BDT, "#mu vs pT_barrel (BDT)", "Response", "mu_vs_pT_BDT_barrel_ele_M", true);
plotGraphs(graphs_mu_DRN, "#mu vs pT_barrel (DRN)", "Response", "mu_vs_pT_DRN_barrel_ele_M", true);
