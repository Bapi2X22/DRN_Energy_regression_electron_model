...
plotGraphs(graphs_sigma_BDT, "#sigma/#mu vs pT (BDT)_endcap", "#sigma/#mu", "sigma_over_mu_vs_pT_BDT_endcap_ele_M", false);
plotGraphs(graphs_sigma_DRN, "#sigma/#mu vs pT (DRN)_endcap", "#sigma/#mu", "sigma_over_mu_vs_pT_DRN_endcap_ele_M", false);
plotGraphs(graphs_mu_BDT, "#mu vs pT (BDT)_endcap", "Response", "mu_vs_pT_BDT_endcap_ele_M", true);
plotGraphs(graphs_mu_DRN, "#mu vs pT (DRN)_endcap", "Response", "mu_vs_pT_DRN_endcap_ele_M", true);
