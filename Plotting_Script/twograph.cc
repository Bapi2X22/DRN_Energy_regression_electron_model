...
void superimposePlotsWithFits() {
    ...
    std::vector<std::string> fileNames = {"plot_ele.root"};
    ...
    lateX->DrawTextNDC(0.10, 0.95, "BDT vs DRN response comparison_DY_electron_model");
    // legend_BDT->Draw();
    ...
    // Save the canvas
    c_twoGraph->SaveAs("BDT_vs_DRN_comparison_DY_electron.pdf");
    c_twoGraph->SaveAs("BDT_vs_DRN_comparison_DY_electron.png");
