...
options.inputFile = 'file:/eos/user/b/bbapi/Energy_regression_by_electron_model/CMSSW_13_3_3/src/condor_scripts/DY_sample_electron_model/'+ options.inputFile
...
output_folder = "/eos/user/b/bbapi/Energy_regression_by_electron_model/CMSSW_13_3_3/src/EM_Skimmer/ZeeAnalyzer/test/DY_nTuplelized_electron_model/"  # <-- Set your desired output folder here
