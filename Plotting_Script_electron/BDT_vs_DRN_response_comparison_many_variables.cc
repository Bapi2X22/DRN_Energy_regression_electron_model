...
void PlotMuAndSigmaFromFiles(
    ...
    ProcessGraphs(fileName, "B", bins, kRed, graphs_mu_BDT, graphs_sigma_BDT);
    ProcessGraphs(fileName, "D", bins, kBlue, graphs_mu_DRN, graphs_sigma_DRN);
    ...
    graphs_mu_BDT[0]->SetTitle("Photon_ideal_IC_Sample");
    ...
    graphs_sigma_BDT[0]->SetTitle("Photon_ideal_IC_Sample");
...
PlotMuAndSigmaFromFiles("Plot_ideal_photon_barrel.root", pT_bins, 0,"Run2_ideal_IC (EB)", "pT", 0.99, 1.015, 0.998, 1.004, 0.0, 0.02, 0.9, 1.1, "pT[GeV/c]", "Barrel");
PlotMuAndSigmaFromFiles("Plot_ideal_photon_endcap.root", pT_bins, 0,"Run2_ideal_IC (EE)", "pT", 0.99, 1.015, 0.998, 1.004, 0.0, 0.02, 0.8, 1.1, "pT[GeV/c]", "Endcap");
