...
void superimposePlotsWithFits() {
    ...
    std::vector<std::string> fileNames = {"Plot_electron_ideal_all.root"};
    ...
    lateX->DrawTextNDC(0.01, 0.95, "Invarient masss distribution for BDT and DRN electron Ideal_IC");
    // legend_BDT->Draw();
    ...
    // Save the canvas
    c_twoGraph->SaveAs("/eos/user/b/bbapi/www/Ideal_Electron/M_ee_plot/BDT_vs_DRN_comparison_mee_Ideal_electron.pdf");
    c_twoGraph->SaveAs("/eos/user/b/bbapi/www/Ideal_Electron/M_ee_plot/BDT_vs_DRN_comparison_mee_Ideal_electron.png");
